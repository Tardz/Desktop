files_last_update=$(jq -r '.date' "/home/jonalm/scripts/rofi/automation/desktop/save_files_data.json")
files_prev_update=$(jq -r '.old_date' "/home/jonalm/scripts/rofi/automation/desktop/save_files_data.json")
...
"  Sync from Desktop [$files_last_update] | $HOME/scripts/rofi/automation/desktop/sync_files.sh"
"  Bisync to Desktop [$files_last_update] | $HOME/scripts/rofi/automation/desktop/bisync_files.sh"
"  Sync from Laptop | $HOME/scripts/rofi/automation/desktop/laptop_sync_files.sh"
"  Bisync to Laptop | $HOME/scripts/rofi/automation/desktop/laptop_bisync_files.sh"
"  Revert [$files_prev_update] | $HOME/scripts/rofi/automation/desktop/revert_files.sh"
)